...
@Import(SpringSpecificationDataSourceInitializedPublisher.Registrar.class)
public abstract class SpringSpecificationJpaBaseConfiguration implements BeanFactoryAware {

	private static final String PERSISTENCE_UNIT_NAME = "springSpecification";

	private final DataSource dataSource;

	private final SpringSpecificationJpaProperties properties;
	...
	protected SpringSpecificationJpaBaseConfiguration(DataSource dataSource, SpringSpecificationJpaProperties properties,
	...
	@ConditionalOnMissingBean(/*value = { LocalContainerEntityManagerFactoryBean.class,
			EntityManagerFactory.class },*/ name = ENTITY_MANAGER_FACTORY_NAME)
	...
	/**
	 * Return the {@link SpringSpecificationJpaProperties}.
	 * @return the properties
	 */
	protected final SpringSpecificationJpaProperties getProperties() {
...
//			OpenEntityManagerInViewFilter.class },*/ name = { OPEN_ENTITY_MANAGER_IN_VIEW_INTERCEPTOR_NAME, OPEN_ENTITY_MANAGER_IN_VIEW_FILTER_NAME })
//	@ConditionalOnProperty(prefix = "spring-specification.jpa", name = "open-in-view", havingValue = "true", matchIfMissing = true)
...
//
//			private final SpringSpecificationJpaProperties jpaProperties;
//
//			protected JpaWebMvcConfiguration(SpringSpecificationJpaProperties jpaProperties) {
//				this.jpaProperties = jpaProperties;
//			}
//
//			@Bean(OPEN_ENTITY_MANAGER_IN_VIEW_INTERCEPTOR_NAME)
//			public OpenEntityManagerInViewInterceptor openEntityManagerInViewInterceptor() {
//				if (this.jpaProperties.getOpenInView() == null) {
//					logger.warn("spring-specification.jpa.open-in-view is enabled by default. "
//							+ "Therefore, database queries may be performed during view "
//							+ "rendering. Explicitly configure "
//							+ "spring-specification.jpa.open-in-view to disable this warning");
//				}
//				return new OpenEntityManagerInViewInterceptor() {
//					@Override
//					public void setEntityManagerFactory(@Qualifier(ENTITY_MANAGER_FACTORY_NAME) EntityManagerFactory emf) {
//						super.setEntityManagerFactory(emf); // TODO check if it's not the Spring's bean
//					}
//				};
//			}
//
