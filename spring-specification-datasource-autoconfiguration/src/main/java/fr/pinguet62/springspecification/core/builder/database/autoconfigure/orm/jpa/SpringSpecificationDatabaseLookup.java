 ...
 * @author Phillip Webb
 */
final class SpringSpecificationDatabaseLookup {

	private static final Log logger = LogFactory.getLog(SpringSpecificationDatabaseLookup.class);
	...
	private SpringSpecificationDatabaseLookup() {
	}
