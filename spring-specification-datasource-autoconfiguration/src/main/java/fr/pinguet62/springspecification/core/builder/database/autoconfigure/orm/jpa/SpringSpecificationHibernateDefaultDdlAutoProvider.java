 ...
 */
class SpringSpecificationHibernateDefaultDdlAutoProvider implements SchemaManagementProvider {

	private final List<SchemaManagementProvider> providers;

	SpringSpecificationHibernateDefaultDdlAutoProvider(List<SchemaManagementProvider> providers) {
